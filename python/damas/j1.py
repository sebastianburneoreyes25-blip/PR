...
def comprobacionDama(x,y,tablero,tablerouser):
    ...
    while flag==False:
        ...
        if x>=2 and y+2<=7:#Podra comer en todas las direcciones diagonales
            if tablero[y+1,x-1]>2 and tablero[y+2,x-2]==0:#Hacia abajo izq
                tablero[y,x]=0
                tablero[y+1,x-1]=0
                tablero[y+2,x-2]=2
                tablerouser[y,x]='  '
                ...
                y=y+2
                x=x-2
            elif tablero[y-1,x-1]>2 and tablero[y-2,x-2]==0:#Hacia arriba izq
                tablero[y,x]=0
                tablero[y-1,x-1]=0
                tablero[y-2,x-2]=2
                tablerouser[y,x]='  '
                ...
                y=y+2
                x=x-2
            elif tablero[y-1,x+1]>2 and tablero[y-2,x+2]==0:#Hacia arriba derecha
                tablero[y,x]=0
                tablero[y-1,x+1]=0
                tablero[y-2,x+2]=2
                tablerouser[y,x]='  '
                ...
                y=y+2
                x=x-2
            elif tablero[y+1,x+1]>2 and tablero[y+2,x+2]==0:#Hacia abajo derecha
                tablero[y,x]=0
                tablero[y+1,x-1]=0
                tablero[y+2,x-2]=2
                tablerouser[y,x]='  '
